...
class Ui_FindAndReplaceDlg(object):
    def setupUi(self, FindAndReplaceDlg):
        ...
        FindAndReplaceDlg.resize(450, 159)
        ...
        FindAndReplaceDlg.setTabOrder(self.replaceLineEdit, self.replaceButton)
        FindAndReplaceDlg.setTabOrder(self.replaceButton, self.caseCheckBox)
        FindAndReplaceDlg.setTabOrder(self.caseCheckBox, self.wholeCheckBox)
        FindAndReplaceDlg.setTabOrder(self.wholeCheckBox, self.replaceAllButton)
        FindAndReplaceDlg.setTabOrder(self.replaceAllButton, self.syntaxComboBox)
        FindAndReplaceDlg.setTabOrder(self.syntaxComboBox, self.closeButton)
    ...
    def retranslateUi(self, FindAndReplaceDlg):
        ...
        self.label_2.setText(_translate("FindAndReplaceDlg", "ReplaceW&ith", None))
        ...
        self.syntaxComboBox.setItemText(0, _translate("FindAndReplaceDlg", "Literaltext", None))
